...
public class AplicarEstimacionDelUmbralDeOtsuAction {
    ...
    private MatrizService matrixService;
    private AplicarUmbralService applyThresholdService;

    public AplicarEstimacionDelUmbralDeOtsuAction(HistogramaService histogramService, MatrizService matrixService, AplicarUmbralService applyThresholdService){
    ...
    public EstimacionDelUmbralDeOtsuResultante ejecutar(Imagen customImage){
        ...
        Histograma histogram = this.histogramService.crearHistograma(customImage);
        ...
        int[][] imageMatrix = this.matrixService.aMatrizDeGrises(customImage.toFXImage());
