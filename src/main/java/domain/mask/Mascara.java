...
public abstract class Mascara {
   ...
   //CONVOLUCIÓN ENTRE LA MÁSCARA Y LA IMAGEN
    ...
    public enum Tipo {
        MEDIA, MEDIANA_PONDERADA, GAUSSIANO, PREWITT, MEDIANA, SOBEL, DERIVATE_DIRECTIONAL_OPERATOR_STANDARD, DERIVATE_DIRECTIONAL_OPERATOR_KIRSH, DERIVATE_DIRECTIONAL_OPERATOR_PREWITT, DERIVATE_DIRECTIONAL_OPERATOR_SOBEL, LAPLACIAN, GAUSSIAN_LAPLACIAN, HIGH_PASS, SUSAN
    }
}
