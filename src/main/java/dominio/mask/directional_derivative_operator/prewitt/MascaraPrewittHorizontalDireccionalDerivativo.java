package dominio.mask.directional_derivative_operator.prewitt;

import dominio.mask.Mascara;

public class MascaraPrewittHorizontalDireccionalDerivativo extends Mascara {

    public MascaraPrewittHorizontalDireccionalDerivativo() {
