...
public class MascaraGaussianaConFactor extends Mascara {

    protected final double desviacionEstandar;
    private MatrizService matrizService;

    public MascaraGaussianaConFactor(double desviacionEstandar) {
    ...
    public MascaraGaussianaConFactor(double desviacionEstandar, int size, Tipo type) {
        super(type, size);
        this.desviacionEstandar = desviacionEstandar;
    }
