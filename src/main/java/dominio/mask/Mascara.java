...
public abstract class Mascara {
   ...
   //CONVOLUCIÓN ENTRE LA MÁSCARA Y LA IMAGEN
    ...
    public enum Tipo {
        MEDIA, MEDIANA_PONDERADA, GAUSSIANO, PREWITT, MEDIANA, SOBEL_VERTICAL, SOBEL_HORIZONTAL, SOBEL, DERIVATE_DIRECTIONAL_OPERATOR_STANDARD, DERIVATE_DIRECTIONAL_OPERATOR_KIRSH, DERIVATE_DIRECTIONAL_OPERATOR_PREWITT, DERIVATE_DIRECTIONAL_OPERATOR_SOBEL, LAPLACIANO, LAPLACIANO_DEL_GUASSIANO, HIGH_PASS, SUSAN, BILATERAL
    }
}
